...
func BenchmarkFact2_20(b *testing.B) { benchmarkFact2(b, 10) }
func BenchmarkFact2_50(b *testing.B) { benchmarkFact2(b, 10) }
func BenchmarkFact2_100(b *testing.B) { benchmarkFact2(b, 10) }
